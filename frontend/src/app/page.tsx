...
const views: Record<string, ReturnType<typeof dynamic>> = {
  ...
  'engine-sling': dynamic(() => import('@/components/SlingView'), { ssr: false }),
  'engine-rigs': dynamic(() => import('@/components/RigView'), { ssr: false }),
  'engine-dogs': dynamic(() => import('@/components/DogKennelView'), { ssr: false }),
  'engine-nudge': dynamic(() => import('@/components/NudgeView'), { ssr: false }),
  'engine-compact': dynamic(() => import('@/components/CompactMemoryView'), { ssr: false }),
  'engine-plugins': dynamic(() => import('@/components/PluginView'), { ssr: false }),
  'engine-quota': dynamic(() => import('@/components/QuotaView'), { ssr: false }),
  'engine-krc': dynamic(() => import('@/components/KRCView'), { ssr: false }),
  // MEOW Stack
...
const NAV = [
  ...
  { id: 'engine-sling', label: 'Sling', icon: '~', group: 'engine' },
  { id: 'engine-rigs', label: 'Rigs', icon: '#', group: 'engine' },
  { id: 'engine-dogs', label: 'Dogs', icon: 'K', group: 'engine' },
  { id: 'engine-nudge', label: 'Nudge', icon: '!', group: 'engine' },
  { id: 'engine-compact', label: 'Memory', icon: 'M', group: 'engine' },
  { id: 'engine-plugins', label: 'Plugins', icon: 'P', group: 'engine' },
  { id: 'engine-quota', label: 'Quota', icon: '$', group: 'engine' },
  { id: 'engine-krc', label: 'KRC', icon: 'T', group: 'engine' },
  // MEOW Stack
